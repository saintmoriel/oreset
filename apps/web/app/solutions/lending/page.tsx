...
const data: SolutionPageData = {
  ...
  problem: {
    ...
    description:
      'AI credit scoring increasingly pulls signals from unstructured text — transaction narrations, USSD session logs, even WhatsApp payment confirmations. These signals are written in local languages and informal registers that models systematically misinterpret.',
    consequences: [
      {
