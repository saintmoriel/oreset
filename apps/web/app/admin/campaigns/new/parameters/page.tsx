...
export default function CampaignParametersPage() {
  ...
  return (
    <div className="cx-card p-8 sm:p-10">
      <p className="cx-label text-accent">Step 2</p>
      <h1 className="cx-page-title mt-2 text-balance text-navy-900">Define parameters</h1>
      ...
      <div className="mt-6 space-y-4">
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            <label className="cx-meta font-medium text-navy-900">Target language</label>
            <select
          ...
          <div>
            <label className="cx-meta font-medium text-navy-900">Domain</label>
            <select
              value={draft.domain}
        ...
        <div>
          <label className="cx-meta font-medium text-navy-900">Batch size (items)</label>
          <input
            type="number"
            min={1}
        ...
        <div>
          <label className="cx-meta font-medium text-navy-900">Media type</label>
          <div className="mt-1.5 grid grid-cols-2 gap-2">
            {CAMPAIGN_MEDIA_TYPES.map((mt) => (
              <label
                key={mt}
                className={cn(
                  'flex cursor-pointer items-center gap-2.5 rounded-lg border p-3 cx-meta transition-colors',
              ...
              >
                ...
                />
                <span className="text-navy-900">{mt}</span>
              </label>
            ))}
          </div>
        </div>
