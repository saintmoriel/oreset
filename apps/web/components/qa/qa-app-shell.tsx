...
const NAV_ITEMS = [
  { label: 'Home', href: '/qa/home', icon: LayoutDashboard },
  { label: 'Queue', href: '/qa/queue', icon: ListChecks },
  { label: 'History', href: '/qa/history', icon: History },
]
...
function SidebarContent({
  ...
  return (
    <div className="flex h-full flex-col">
      <Link href="/qa/home" className="flex items-center gap-2 px-4 py-4" aria-label="Oreset home">
...
export function QaAppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-svh bg-background">
      ...
      <div className="flex h-14 items-center justify-between border-b border-border bg-navy-50 px-4 lg:hidden">
        <Link href="/qa/home" className="flex items-center gap-2" aria-label="Oreset home">
